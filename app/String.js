...
const string = new LocalizedString({
	en:{
		...
		SignupDialogHeader: 'Sign up a new account',
		ErrorDialogHeader: 'Error',
		ForgotPasswordDialogHeader: 'Forgot Your Password?',
		...
		EnterEmailToRecoverPassword:'Enter your Email address to recover your password',
		Biography: 'Biography',
		...
		Delete: 'Delete',
		Activate: 'Activate',
		ActivateToBecomeAnInstructor: 'Activate to become an instructor',
